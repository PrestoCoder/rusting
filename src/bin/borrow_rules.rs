fn main() {
    ...
    let r2 = &mut s1;  // OK now: r1 is no longer active (Non-Lexical Lifetimes)
    r2.push_str("!");
    println!("{r2}");   // "abc!!"
    ...
    // The block below is commented out because it does NOT compile:
    //
    // let y: &String;
    // {
    //     let x = String::from("asdf"); // x lives in this inner scope
    //     y = &x;
    // } // x dropped here — heap freed
